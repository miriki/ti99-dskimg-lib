...
import com.miriki.ti99.dskimg.domain.constants.VolumeConstants;
...
public final class ImageFormatter {
    ...
    // private static final byte ERASED = DiskLayoutConstants.ERASED_BYTE;
    ...
    private static void clearAllSectors(Ti99Image image, int totalSectors) {
        ...
        Arrays.fill(empty, (byte) DiskLayoutConstants.ERASED_BYTE);
    ...
    private static void writeVib(Ti99Image image, DiskFormat fmt, AllocationBitmap abm) {
    	...
    	log.trace( "  volume:             '{}'", VolumeConstants.DEFAULT_VOLUME_NAME );
    	...
    	log.trace( "  getDensity.ordinal: '{}'", fmt.getDensity().getCode() );
    	log.trace( "  id:                 '{}'", VolumeConstants.DEFAULT_DISK_ID );
    	log.trace( "  create:             '{}'", 0 );
    	log.trace( "  update:             '{}'", 0 );
    	log.trace( "  backup:             '{}'", 0 );
        ...
        VolumeInformationBlock vib = new VolumeInformationBlock(
        		VolumeConstants.DEFAULT_VOLUME_NAME, // default name
                fmt.getTotalSectors(),
                fmt.getSectorsPerTrack(),
                fmt.getTracksPerSide(),
                fmt.getSides(),
                fmt.getDensity().getCode(),
                VolumeConstants.DEFAULT_DISK_ID,     // disk type
